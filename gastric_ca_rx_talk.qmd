...
ECF $\rightarrow$ Surgery $\rightarrow$ ECF $\rightarrow$ ChemoRT vs ECF $\rightarrow$ Surgery $\rightarrow$ ECF
...
Chemo $\rightarrow$ Surgery with cytoreduction $\rightarrow$ Chemo vs Chemo $\rightarrow$ Surgery with cytoreduction + HIPEC $\rightarrow$ Chemo
...
FLOT $\rightarrow$ Gastrectomy + HIPIC $\rightarrow$ vs FLOT $\rightarrow$ Gastrectomy $\rightarrow$
