...
Efficacy of HIPEC = $\function$ (Histology, completeness of cytoreduction, prior surgery score (PSS), PIC) T stage of tumor is not important


## HPIEC morbidity

Function of age >60, ECOG, hyopalbumenia, PCI score, number of bowel resections, diagphragm involvement, distal pancreatectomy

## HIPEC Exclusion

Laparoscopy prior to HIPEC. Exclusions for HIPEC:

- Large-volume carcinomatosis with PCI>20
- Extensive involvement of small bowel mesentery or serosa
- Extensive porta hepatis involvement
- Long-segment ureteral involvement
- Multipe intrahepatic parenchymal liver nodules
...
HIPECT4 trial shows improvement in local control with HIPEC but no change in DFS or OS
::::: columns
::: {.column width="50%"}
...
Para-aortic node involvement is contraindication
...
{{< rrqr https://gisurgonc.github.io/orientation width=500 height=500 >}}
