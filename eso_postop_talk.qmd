...
### Esophagus resection
- Total esophagectomy (cervical incision)
- Partial/subtotal esophagectomy (thoracic incision)

### Esophagus reconstruction
- Stomach (98%)
- Colon

Anastomosis = surgical junction between espohagus and its substitute
...
- Higher risk of leak
- Less morbidity if leak occurs
:::

::: {.column width="70%"}
![](images/Eso_Total_AnastArtboard 2@4x.png)
:::
:::
...
- Laparoscopy 
- Dissection of mediastinal esophagus from neck and abdominal incisions
- Can be done open, laparosopic, or robotic
:::
...
::: columns
::: {.column width="30%"}
Neoesophagus constructed with linear stapler
