...
::::: columns
::: {.column width="50%"}
Minimally-invasive feasible in 95% of cases
...
CT esophagram sensitivity is best if side-holes of NG tube are immediately adjacent to the anastomosis
...
Clearance of oropharyngeal secretions::
...
::: {.column width="50%"}
![](https://deidt7p41jzcy.cloudfront.net/sb_necrosis_ct.png){.r-stretch}
:::
:::::
...
::: {.column width="50%"}
![](https://deidt7p41jzcy.cloudfront.net/sb_necrosis_ct2.png){.r-stretch}
:::
:::::
::::::
...
- Reduced release of endogenous insulin
...
$\Rightarrow$ Requires coordination between surgical and endocrinology teams and nursing

## Oral Nutrition

Once cleared for thin liquids by MBS

- Water 1oz q hour orally 
- Medications switched to oral
- Protein shakes 2oz at a time if water tolerated
- Protein shakes 4oz at a time if 2 oz tolerated

## Diet Orders

Fresh post-op esophagectomy patients are NOT ordered for clear liquids or full liquids. Instead:

- NPO
- Supplement Intake Regimen

When patient is advanced to protein shakes:

- Enter a Supplement Regimen

## NPO Orders

![](images/NPO_orders.png)
## Supplement Intake Regimen

![](images/Supplement_orders.png)
...
NPO Except: Check "Other" and specify in diet comments.

-   Medicines with thickened water. or
-   Water 1oz per hour + meds with water. or
-   Ensure Max Protein + Water + meds with water 2-4oz at at time
...
Patients who will return to the OR need and NPO order AND need a separate order to hold tube feeds.
...
## Esophagectomy Postop Care Talk

{{< qrcode https://gisurgonc.github.io/talks/eso_postop_care.htm width=500 height=500 >}}
